...
import { c as createLucideIcon, e as composeRefs, b as useComposedRefs, S as Slot$2, f as cva, g as createSlot$1, u as useAuth, G as GraduationCap, a as BookOpen, B as Button } from "./useAuth-DmwR_m9H.js";
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, u as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, a as RequestStatusResponseStatus, U as UnknownError, b as RequestStatusDoneNoReplyErrorCode, d as RejectError, e as CertifiedRejectErrorCode, f as UNREACHABLE_ERROR, I as InputError, g as InvalidReadStateRequestErrorCode, h as ReadRequestType, i as Principal, k as IDL, m as MissingCanisterIdErrorCode, H as HttpAgent, n as encode, Q as QueryResponseStatus, o as UncertifiedRejectErrorCode, p as isV3ResponseBody, q as isV2ResponseBody, s as UncertifiedRejectUpdateErrorCode, t as UnexpectedErrorCode, w as decode, x as Subscribable, y as pendingThenable, z as resolveEnabled, A as shallowEqualObjects, B as resolveStaleTime, D as noop$1, F as environmentManager, G as isValidTimeout, J as timeUntilStale, K as timeoutManager, L as focusManager, O as fetchState, V as replaceData, W as notifyManager, X as hashKey, Y as getDefaultState, r as reactExports, Z as shouldThrowError, _ as useQueryClient, $ as useInternetIdentity, a0 as createActorWithConfig, j as jsxRuntimeExports, a1 as React, a2 as reactDomExports, v as vt, c as cn, a3 as shimExports, R as React2, a4 as useRouter, a5 as Link, S as Skeleton, N as Navigate, a6 as Record, a7 as Opt, a8 as Variant, a9 as Vec, aa as Service, ab as Func, ac as Nat, ad as Nat8, ae as Text, af as Bool, ag as Null, ah as Int, ai as Principal$1 } from "./index-D39pcanF.js";
...
const Menu$1 = createLucideIcon("menu", __iconNode$2);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Layout({ children, isAdmin = false, userName }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 bg-card border-b border-border shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            "data-ocid": "nav-logo",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary flex items-center justify-center shadow-sm transition-smooth group-hover:bg-primary/90", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "w-5 h-5 text-primary-foreground" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg text-foreground tracking-tight hidden sm:block", children: "Prakarn Resonance" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-base text-foreground tracking-tight sm:hidden", children: "PR" })
            ]
          }
        ),
        isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "nav",
          {
            ...
            "data-ocid": "nav-links",
            children: navLinks.map(({ to, label, icon: Icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                to,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: isAuthenticated ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "w-7 h-7", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "text-xs bg-primary/15 text-primary font-semibold", children: initials }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block text-sm font-medium max-w-[120px] truncate", children: displayName })
                ]
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-52", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuLabel, { className: "text-xs text-muted-foreground font-normal", children: "Signed in as" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuLabel, { className: "font-semibold -mt-1", children: displayName }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
              navLinks.map(({ to, label, icon: Icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                DropdownMenuItem,
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: mobileMenuOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-5 h-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu$1, { className: "w-5 h-5" })
            }
          )
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", "data-ocid": "nav-login-cta", children: "Sign in" }) }) })
      ] }),
      isAuthenticated && mobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden border-t border-border py-3 space-y-1", children: [
        navLinks.map(({ to, label, icon: Icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            to,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border py-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 rounded bg-primary/15 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "w-3 h-3 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground/70", children: "Prakarn Resonance" })
      ] }),
      ...
      isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
...
function ProtectedRoute({
  ...
  if (isLoading || isAuthenticated && isRoleLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 w-64", "data-ocid": "protected-route-loading", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-full rounded-lg" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-6 w-3/4 rounded" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-6 w-1/2 rounded" })
    ] }) });
  }
  if (!isAuthenticated) {
...
const Lecture = Record({
  "id": LectureId,
  "title": Text,
  "topic": Text,
  "description": Text,
  "videoFile": ExternalBlob$1,
  "uploadedAt": Int
});
const Note = Record({
  "id": NoteId,
...
const LectureInput = Record({
  "title": Text,
  "topic": Text,
  "description": Text,
  "videoFile": ExternalBlob$1
});
const NoteInput = Record({
  "title": Text,
  "topic": Text,
  "file": ExternalBlob$1,
  "description": Text
...
Service({
  ...
  "deleteLecture": Func([LectureId], [], []),
  "deleteNote": Func([NoteId], [], []),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getLecture": Func([LectureId], [Opt(Lecture)], ["query"]),
  "getNote": Func([NoteId], [Opt(Note)], ["query"]),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "listLectures": Func([], [Vec(Lecture)], ["query"]),
  "listNotes": Func([], [Vec(Note)], ["query"]),
  "uploadLecture": Func([LectureInput], [Lecture], []),
  "uploadNote": Func([NoteInput], [Note], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const LectureId2 = IDL2.Nat;
  const NoteId2 = IDL2.Nat;
  const ExternalBlob2 = IDL2.Vec(IDL2.Nat8);
  const Lecture2 = IDL2.Record({
    "id": LectureId2,
    "title": IDL2.Text,
    "topic": IDL2.Text,
    "description": IDL2.Text,
    "videoFile": ExternalBlob2,
    "uploadedAt": IDL2.Int
  });
  ...
  const LectureInput2 = IDL2.Record({
    "title": IDL2.Text,
    "topic": IDL2.Text,
    "description": IDL2.Text,
    "videoFile": ExternalBlob2
  });
  const NoteInput2 = IDL2.Record({
    "title": IDL2.Text,
    "topic": IDL2.Text,
    "file": ExternalBlob2,
    "description": IDL2.Text
  ...
  return IDL2.Service({
    ...
    "deleteLecture": IDL2.Func([LectureId2], [], []),
    "deleteNote": IDL2.Func([NoteId2], [], []),
    "getCallerUserRole": IDL2.Func([], [UserRole2], ["query"]),
    "getLecture": IDL2.Func([LectureId2], [IDL2.Opt(Lecture2)], ["query"]),
    "getNote": IDL2.Func([NoteId2], [IDL2.Opt(Note2)], ["query"]),
    "isCallerAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "listLectures": IDL2.Func([], [IDL2.Vec(Lecture2)], ["query"]),
    "listNotes": IDL2.Func([], [IDL2.Vec(Note2)], ["query"]),
    "uploadLecture": IDL2.Func([LectureInput2], [Lecture2], []),
    "uploadNote": IDL2.Func([NoteInput2], [Note2], [])
  });
};
...
async function from_candid_Lecture_n13(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n14(_uploadFile, _downloadFile, value);
}
async function from_candid_Note_n17(_uploadFile, _downloadFile, value) {
...
async function to_candid_ExternalBlob_n23(_uploadFile, _downloadFile, value) {
  return await _uploadFile(value);
}
async function to_candid_LectureInput_n21(_uploadFile, _downloadFile, value) {
  return await to_candid_record_n22(_uploadFile, _downloadFile, value);
}
async function to_candid_NoteInput_n24(_uploadFile, _downloadFile, value) {
...
async function to_candid_record_n25(_uploadFile, _downloadFile, value) {
  return {
    title: value.title,
    topic: value.topic,
...
export {
  ...
  createSlottable as e,
  createContextScope$1 as f,
  Primitive as g,
  ProtectedRoute as h,
  useLectures as i,
  useUploadLecture as j,
  useDeleteLecture as k,
  useNotes as l,
  useUploadNote as m,
  useDeleteNote as n,
