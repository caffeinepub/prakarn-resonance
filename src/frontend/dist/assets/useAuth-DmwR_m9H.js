import { r as reactExports, j as jsxRuntimeExports, a1 as React, aj as clsx, c as cn, $ as useInternetIdentity, _ as useQueryClient } from "./index-D39pcanF.js";
...
function useAuth() {
  const { login, clear, isLoginSuccess, identity, loginStatus } = useInternetIdentity();
  ...
  const handleLogin = reactExports.useCallback(async () => {
    try {
      ...
      const err = error;
      if ((err == null ? void 0 : err.message) === "User is already authenticated") {
        await clear();
