import { j as jsxRuntimeExports, r as reactExports, c as cn, R as React2, v as vt, S as Skeleton } from "./index-D39pcanF.js";
import { R as Root$1, T as Trigger, W as WarningProvider, C as Content, c as composeEventHandlers, a as Title, D as Description, b as Close, d as createDialogScope, P as Portal, O as Overlay, e as createSlottable, f as createContextScope, g as Primitive, u as useIsCallerAdmin, h as ProtectedRoute, L as Layout, F as FileText, i as useLectures, j as useUploadLecture, k as useDeleteLecture, l as useNotes, m as useUploadNote, n as useDeleteNote, X, I as Input, B as Badge } from "./useNotes-D2HQH_X2.js";
import { c as createLucideIcon, b as useComposedRefs, d as buttonVariants, B as Button } from "./useAuth-DmwR_m9H.js";
/**
...
function FileDropZone({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      htmlFor: inputId,
      className: `relative border-2 border-dashed rounded-xl p-8 text-center cursor-pointer transition-smooth block ${isDragOver ? "border-primary bg-primary/5" : file ? "border-accent bg-accent/5" : "border-border hover:border-primary/50 hover:bg-muted/30"}`,
      onDragOver: (e) => {
        e.preventDefault();
        setIsDragOver(true);
      },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => {
              var _a;
              return onFileChange(((_a = e.target.files) == null ? void 0 : _a[0]) ?? null);
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: file ? /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-6 h-6" }) : icon
            }
          ),
          file ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm truncate max-w-xs", children: file.name }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-medium text-foreground text-sm", children: "Drop file here or click to browse" }),
...
function UploadForm({ type, form, setForm, onSubmit }) {
  const isLecture = type === "lecture";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-6 space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg bg-primary/10", children: isLecture ? /* @__PURE__ */ jsxRuntimeExports.jsx(Film, { className: "w-4 h-4 text-primary" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-4 h-4 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display font-semibold text-foreground", children: [
          "Upload ",
          isLecture ? "Lecture Video" : "Notes PDF"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: `${type}-title`, children: "Title *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: `${type}-title`,
            placeholder: isLecture ? "Introduction to Quantum Mechanics" : "Chapter 3 Study Notes",
            value: form.title,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: `${type}-topic`, children: "Topic *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: `${type}-topic`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("datalist", { id: `${type}-topics`, children: TOPIC_SUGGESTIONS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: t }, t)) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: `${type}-description`, children: "Description" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Textarea,
        {
          id: `${type}-description`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FileDropZone,
      {
        ...
        icon: isLecture ? /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "w-6 h-6" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-6 h-6" }),
        hint: isLecture ? "MP4, WebM, MOV up to 2 GB" : "PDF documents only",
        inputId: `${type}-file`
      }
    ),
    form.isUploading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressBar, { value: form.progress })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          onClick: onSubmit,
          disabled: form.isUploading || !form.title.trim() || !form.topic.trim() || !form.file,
          "data-ocid": `${type}-upload-submit`,
          children: form.isUploading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
...
function ContentTable({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 w-full rounded-lg" }, i)) });
  }
  if (rows.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 rounded-full bg-muted mb-4", children: type === "lecture" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Film, { className: "w-8 h-8 text-muted-foreground" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-8 h-8 text-muted-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "font-display font-semibold text-foreground mb-1", children: [
            "No ",
            type === "lecture" ? "lectures" : "notes",
            " yet"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground max-w-xs", children: [
            "Upload your first ",
            type === "lecture" ? "lecture video" : "notes PDF",
            " ",
            "to get started."
          ] })
        ]
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:grid grid-cols-[1fr_auto_auto_auto] gap-4 px-4 py-3 bg-muted/40 border-b border-border text-xs font-display font-semibold text-muted-foreground uppercase tracking-wide", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Title" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-28 text-center", children: "Topic" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-28 text-center", children: "Upload Date" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-16 text-center", children: "Actions" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border", children: rows.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-medium text-foreground truncate", children: row.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden flex flex-wrap gap-2 mt-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs", children: row.topic }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: formatDate(row.uploadedAt) })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center justify-center w-28", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "truncate max-w-full", children: row.topic }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center justify-center w-28 text-sm text-muted-foreground", children: formatDate(row.uploadedAt) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-end md:justify-center w-full md:w-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
                  ...
                  ". Students will lose access immediately. This action cannot be undone."
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { children: "Keep it" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  AlertDialogAction,
                  {
...
function LecturesSection() {
  ...
  const handleUpload = async () => {
    ...
    try {
      await uploadLecture.mutateAsync({
        ...
        videoFile: form.file,
        onProgress: (pct) => setForm((f) => ({ ...f, progress: Math.round(pct) }))
      });
      ue.success("Lecture uploaded successfully!");
  ...
  const handleDelete = async (id) => {
    try {
      ...
      ue.success("Lecture deleted.");
    } catch {
      ue.error("Failed to delete lecture.");
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-foreground", children: "Lectures" }),
      ...
      !form.showForm && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
    ...
    form.showForm && /* @__PURE__ */ jsxRuntimeExports.jsx(
      UploadForm,
      {
        type: "lecture",
        form,
...
function NotesSection() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      ue.success("Notes uploaded successfully!");
      setForm(INITIAL_FORM);
    } catch {
      ue.error("Upload failed. Please try again.");
      setForm((f) => ({ ...f, isUploading: false, progress: 0 }));
  ...
  const handleDelete = async (id) => {
    try {
      ...
      ue.success("Notes deleted.");
    } catch {
      ue.error("Failed to delete notes.");
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-foreground", children: "Notes" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mt-0.5", children: [
          notes.length,
          " notes document",
          notes.length !== 1 ? "s" : ""
...
function DashboardPage() {
  ...
  const [activeTab, setActiveTab] = reactExports.useState("lectures");
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedRoute, { requireAdmin: true, isAdmin, isRoleLoading: isLoading, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { isAdmin, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-3xl text-foreground", children: "Instructor Dashboard" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-1", children: "Manage your video lectures and course notes." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: ["lectures", "notes"].map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            role: "tab",
            ...
            className: `flex items-center gap-2 px-5 py-2 rounded-lg font-display font-semibold text-sm transition-smooth ${activeTab === tab ? "bg-card text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
            "data-ocid": `tab-${tab}`,
            children: [
              tab === "lectures" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Film, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-4 h-4" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: activeTab === "lectures" ? /* @__PURE__ */ jsxRuntimeExports.jsx(LecturesSection, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(NotesSection, {}) })
  ] }) }) });
}
export {
